...
<button class="w-full bg-white hover:bg-gray-100 text-gray-600 border hover:shadow font-bold  px-4 rounded-xl py-3 my-1"><img src="/resources/images/google-logo.png" class="inline-block mr-2 h-6 rounded p-1" alt="Google"><span class="py-3">Google 로그인</span></button>
</a>
<a href="/oauth/provider/google.php?action=login">
<button class="w-full hover:bg-yellow-500 font-bold  px-4 rounded-xl py-3 my-1 hover:shadow" style="background-color: #FEE500; color: rgba(0,0,0,.85);">
<img src="/resources/images/kakao_login_large_narrow-2.png" class="inline-block mr-2 h-6 rounded p-1" alt="Kakao"><span class="py-3">카카오 로그인</span></button>
</a>
</div>
