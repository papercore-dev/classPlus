...
<a href="/oauth/provider/kakao.php?action=login" class="w-full block mt-4 text-center text-blue-500">카카오톡으로 시작할래요 <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-6 h-6 inline-block">
