...
$getBoardID = "SELECT boardID FROM `posts` WHERE postID = '".$_GET["id"]."' AND postHidden = '0' AND userID = '".$_SESSION['userID']."' AND signMethod = '".$_SESSION['signMethod']."'";
...
$headName = $boardName." 게시판의 글 수정하기";
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.1/jquery.min.js"></script>
  <div class="mx-auto w-full">
    <form action="/form/postEdit.php" method="POST">
      <div class="">
        <input
          type="text"
          name="title"
      ...
      <div>
        ...
        <input type="hidden" name="postURL" id="postURL" value="<?php echo $_GET["id"];?>" />
        <button
...
<img src="<?php echo $image;?>" id="preview" class="w-1/2 rounded-lg">
