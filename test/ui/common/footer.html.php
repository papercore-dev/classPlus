...
<a href="javascript:Turbo.visit(`/app.php`)" class="pt-2 pb-2 rounded-full bg-blue-500 hover:bg-blue-700 text-white flex flex-col flex-grow items-center justify-center
...
<span class="text-sm capitalize">게시판</span>
</a>

<a href="javascript:Turbo.visit(`/menu.php`)" class="pt-2 pb-2 flex flex-col flex-grow items-center justify-center
		overflow-hidden whitespace-no-wrap text-sm transition-colors duration-100
		ease-in-out hover:bg-gray-200 focus:text-orange-500">
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
