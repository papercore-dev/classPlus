...
<a href="/mobilePass.php" class="pt-2 pb-2 rounded-full bg-blue-500 hover:bg-blue-700 text-white flex flex-col flex-grow items-center justify-center
...
<span class="text-sm capitalize">내정보</span>
</a>
</nav>
